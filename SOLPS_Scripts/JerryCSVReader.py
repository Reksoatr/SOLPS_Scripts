...
if JND == 1:
    ...
    NeuDen_2 = SOLPSPLOT('12',['101', '102', '103', '104', '105'],RADC='rrsep',AVG=True)
    ...
    NeuDen_2.RadProf('NeuDen',LOG10=2,AX=NeuDRadPlot,Markers=False,PlotScheme=['.','.','.','.','.','-'])
    NeuDen_2.RadProf('MolDen',LOG10=2,AX=NeuDRadPlot,Markers=False,PlotScheme=['.','.','.','.','.','-'])
    #NeuDen_3.RadProf('NeuDen',LOG10=2,AX=NeuDRadPlot,Markers=False)
    #NeuDen_4.RadProf('NeuDen',LOG10=2,AX=NeuDRadPlot,Markers=False)    
    ...
    NeuDRadPlot.legend(['Exp D Density', 'KN1D_H', 'KN1D_H2','Shot12_AVG_D','Shot12_AVG_D2'])
