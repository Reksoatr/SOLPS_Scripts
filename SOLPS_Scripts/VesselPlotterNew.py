    ...
    ** Setup **
    ...
    def __init__(self, Shot, Attempts, Parameters=None, **kwargs):
        ...
        self.DefaultSettings = {'TimeRange' : [0.90,1.00],  
                     ...
                     'GRID': False,
                     'AX' : None,
                     'BASEDRT': r"C:/Users/Richard/Google Drive/School stuff/College of William and Mary/Research/SOLPS Stuff/SOLPS_2D_prof/",
                     'TOPDRT' : r"C:/Users/Richard/Google Drive/School stuff/College of William and Mary/Research/SOLPS Stuff/" }
