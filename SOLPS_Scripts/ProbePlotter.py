...
'''
Base012=SOLPSPLOT('12',[101,120])
Base025=SOLPSPLOT('025',[161,166])
...
Rad012Plot[0,1].semilogy(Probe012['rho_ON']/1000,Probe012['Ne_O'],'.',markersize=1)
...
Base025.RadProf('Ne',JXA=96,RADC='rrsep',AX=Rad025Plot[0,1],PlotScheme=['b'],Markers=False,LOG10=2)
Rad025Plot[0,1].semilogy(Probe025['rho_ON']/1000,Probe025['Ne_O'],'.', markersize=1)
...
Rad012Plot[1,1].plot(Probe012['rho_OT']/1000,Probe012['Te_O'],'.',markersize=1)
...
Rad012Plot[0,0].semilogy(Probe012['rho_IN']/1000,Probe012['Ne_I'],'.',markersize=1)
Rad012Plot[0,0].set_title('High Ip Inner Divertor Ne')
#Rad012Plot[0,0].get_legend().remove()

Base025.RadProf('Ne',JXA=1,RADC='rrsep',AX=Rad025Plot[0,0],PlotScheme=['b'],Markers=False,LOG10=2)
Rad025Plot[0,0].semilogy(Probe025['rho_IN']/1000,Probe025['Ne_I'],'.',markersize=1)
...
Rad012Plot[1,0].plot(Probe012['rho_IT']/1000,Probe012['Te_I'],'.',markersize=1)
